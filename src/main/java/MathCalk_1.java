...
public class MathCalk_1 {
    ...
    public void calculationTest() throws InterruptedException {
        ...
        // поскольку там не текст, а картинка (в которую спрятан treasure), то используем getAttribute("...")
        System.out.println(treasure.getAttribute("valuex"));
